...
const enUS: Translations = {
  ...
  login_title: 'Log in',
  login_welcomeBack: 'Welcome to Virta Go.',
  ...
  greeting_appIntro: 'This app is called Virta Go. Let us show you around.',
...
const ptPT: Translations = {
  ...
  login_welcomeBack: 'Bem-vindo ao Virta Go.',
  login_tutorAdmin: 'Tutor / Admin',
  ...
  greeting_appIntro: 'Esta aplicação chama-se Virta Go. Deixa-nos mostrar-te como funciona.',
...
const ptBR: Translations = {
  ...
  greeting_appIntro: 'Este aplicativo se chama Virta Go. Vamos te mostrar como funciona.',
...
const es: Translations = {
  ...
  login_welcomeBack: 'Bienvenido a Virta Go.',
  login_tutorAdmin: 'Tutor / Admin',
  ...
  greeting_appIntro: 'Esta aplicación se llama Virta Go. Déjanos mostrarte cómo funciona.',
...
const no: Translations = {
  ...
  login_welcomeBack: 'Velkommen til Virta Go.',
  ...
  greeting_appIntro: 'Denne appen heter Virta Go. La oss vise deg rundt.',
...
const fr: Translations = {
  ...
  login_welcomeBack: 'Bienvenue sur Virta Go.',
  ...
  greeting_appIntro: "Cette application s'appelle Virta Go. Laisse-nous te la faire découvrir.",
...
const it: Translations = {
  ...
  login_title: 'Accedi',
  login_welcomeBack: 'Benvenuto su Virta Go.',
  login_tutorAdmin: 'Tutor / Admin',
  ...
  greeting_appIntro: "Questa app si chiama Virta Go. Lascia che ti mostriamo come funziona.",
...
const hu: Translations = {
  ...
  login_welcomeBack: 'Üdvözlünk a Virta Go-ban.',
  ...
  greeting_appIntro: 'Ezt az alkalmazást Virta Go-nak hívják. Megmutatjuk, hogyan működik.',
