...
const enUS: Translations = {
  ...
  missions_noVideos: 'No missions added by tutor yet.',
  missions_subtitle: 'Missions picked for you. Tap one to watch.',
...
const ptPT: Translations = {
  ...
  virtago_resetChat: 'Nova conversa',
  ...
  missions_noVideos: 'O tutor ainda não adicionou missões.',
  missions_subtitle: 'Missões escolhidas para ti. Toca numa para ver.',
...
const es: Translations = {
  ...
  missions_noVideos: 'Tu tutor todavía no ha añadido misiones.',
  missions_subtitle: 'Misiones elegidas para ti. Toca una para verla.',
...
const no: Translations = {
  ...
  missions_noVideos: 'Ingen oppdrag er lagt til av foresatt ennå.',
  missions_subtitle: 'Oppdrag valgt for deg. Trykk på et for å se det.',
...
const fr: Translations = {
  ...
  virtago_resetChat: 'Nouvelle discussion',
  ...
  missions_noVideos: "Le tuteur n'a pas encore ajouté de missions.",
  missions_subtitle: 'Missions choisies pour toi. Touche-en une pour la regarder.',
...
const it: Translations = {
  ...
  missions_noVideos: 'Il tutor non ha ancora aggiunto missioni.',
  missions_subtitle: 'Missioni scelte per te. Toccane una per guardarla.',
...
const hu: Translations = {
  ...
  virtago_resetChat: 'Új beszélgetés',
  ...
  missions_noVideos: 'A gondviselőd még nem adott hozzá küldetéseket.',
  missions_subtitle: 'Neked válogatott küldetések. Koppints egyre a megtekintéshez.',
